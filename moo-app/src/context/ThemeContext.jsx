...
export const UI_STRINGS = {
  en: {
    ...
    placed:            'placed, need',
    more:              'more',
    clickFirstPoint:   'Click first point to close this shape',
  ...
  de: {
    ...
    clickToPlace:      'Klicke um Punkte zu setzen',
    placed:            'gesetzt, noch',
    more:              'mehr',
    clickFirstPoint:   'Ersten Punkt anklicken um die Form zu schließen',
  ...
  es: {
    ...
    clickToPlace:      'Haz clic para colocar puntos',
    placed:            'colocados, faltan',
    more:              'más',
    clickFirstPoint:   'Haz clic en el primer punto para cerrar la forma',
